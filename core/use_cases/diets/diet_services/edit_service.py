...
class EditDietServiceUseCase:
    ...
    def execute(self, service_id: int, is_local: bool, breakfast_price: float, 
        ...
        Args:
            service_id: ID del servicio a editar
        ...
        existing_service = self.diet_service_repository.get_by_id(service_id)
        ...
        return self.diet_service_repository.save(existing_service)